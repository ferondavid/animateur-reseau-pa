...
export default async function AnimateurPage() {
  ...
  const [
    ...
    supabase.from("magasins").select("id, nom, enseigne, ville, region, latitude, longitude, contact_telephone, niveau, sous_enseigne").eq("statut", "actif").not("latitude", "is", null).order("nom"),
