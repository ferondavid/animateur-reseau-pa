...
type Carte = { href: string; titre: string; sous: string; emoji: string; bg: string; color: string };

const CARTES: Carte[] = [
  { href: "/pilotage", titre: "Pilotage", sous: "Cockpit réseau, KPIs, magasins à risque", emoji: "📊", bg: "linear-gradient(135deg,#D9EAFB,#BFDBF7)", color: "#2D6FD0" },
  { href: "/animateur/sante", titre: "Santé réseau 360", sous: "Scorecard des 40 magasins", emoji: "🩺", bg: "linear-gradient(135deg,#E4DDFB,#D3C7F7)", color: "#6B4FD8" },
  { href: "/animateur/classement", titre: "Classement CA", sous: "CA Leaders & BFA des associés", emoji: "🏆", bg: "linear-gradient(135deg,#FBF1D8,#F6E3B0)", color: "#B07D14" },
  { href: "/animateur/rapport", titre: "Rapport d'activité", sous: "Synthèse visites, remontées, RDV", emoji: "📄", bg: "linear-gradient(135deg,#D2F2E7,#B5E9D5)", color: "#0F8C68" },
  { href: "/animateur/notes", titre: "Notes vocales", sous: "Mémos terrain de l'animateur", emoji: "🎤", bg: "linear-gradient(135deg,#F9DCE7,#F4C4D6)", color: "#C04B72" },
];
