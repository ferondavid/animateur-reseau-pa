...
import { updateVisite } from "../actions";
...
interface Visite {
  ...
  commentaire_confiance: string | null;
  note_business: number | null;
  commentaire_business: string | null;
}
...
export default function FormulaireModifierVisite({
  visite,
  magasins,
}: {
  visite: Visite;
  ...
  const [statut, setStatut] = useState(visite.statut);

  return (
    <form action={updateVisite} className="space-y-6">
      <input type="hidden" name="id" value={visite.id} />
      <input type="hidden" name="magasin_id" value={visite.magasin_id ?? ""} />
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm space-y-4">
        ...
        <div>
          ...
          <select
            name="magasin_id"
            required
            defaultValue={visite.magasin_id ?? ""}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              name="date_prevue"
              required
              defaultValue={visite.date_prevue ?? ""}
          ...
          <div>
            ...
            <input
              type="date"
              name="date_realisee"
              defaultValue={visite.date_realisee ?? ""}
              className={inputClass}
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              name="duree_minutes"
              min={0}
              defaultValue={visite.duree_minutes ?? ""}
              placeholder="ex. 90"
              className={inputClass}
            />
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm space-y-4">
            ...
            <div>
              ...
              <textarea
                name="compte_rendu"
                rows={4}
                defaultValue={visite.compte_rendu ?? ""}
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                defaultValue={visite.points_positifs ?? ""}
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                defaultValue={visite.points_attention ?? ""}
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                defaultValue={visite.actions_decidees ?? ""}
            ...
            <div>
              ...
              <textarea
                ...
                rows={2}
                defaultValue={visite.prochaine_etape ?? ""}
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <select
                  name="note_confiance"
                  defaultValue={visite.note_confiance ?? ""}
                  className={selectClass}
                >
                  <option value="">—</option>
                  {[1, 2, 3, 4, 5].map((n) => (
                ...
                <textarea
                  ...
                  rows={2}
                  defaultValue={visite.commentaire_confiance ?? ""}
              ...
              <div className="space-y-2">
                ...
                <select
                  name="note_business"
                  defaultValue={visite.note_business ?? ""}
                  className={selectClass}
                >
                  <option value="">—</option>
                  {[1, 2, 3, 4, 5].map((n) => (
                ...
                <textarea
                  ...
                  rows={2}
                  defaultValue={visite.commentaire_business ?? ""}
                  placeholder="Commentaire…"
                  className={textareaClass}
                />
              </div>
